...
class Listbox extends MultipleSelect
{
    ...
    protected static $css = [
        '/packages/admin/laravel-admin/bootstrap-duallistbox/dist/bootstrap-duallistbox.min.css',
    ];

    protected static $js = [
        '/packages/admin/laravel-admin/bootstrap-duallistbox/dist/jquery.bootstrap-duallistbox.min.js',
    ];
