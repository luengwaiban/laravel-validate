...
class File extends Field
{
    ...
    protected static $css = [
        '/packages/admin/laravel-admin/bootstrap-fileinput/css/fileinput.min.css?v=4.3.7',
    ];
     ...
     */
    protected static $js = [
        '/packages/admin/laravel-admin/bootstrap-fileinput/js/plugins/canvas-to-blob.min.js?v=4.3.7',
        '/packages/admin/laravel-admin/bootstrap-fileinput/js/fileinput.min.js?v=4.3.7',
    ];
