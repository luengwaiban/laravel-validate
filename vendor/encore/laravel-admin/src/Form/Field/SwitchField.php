...
class SwitchField extends Field
{
    protected static $css = [
        '/packages/admin/laravel-admin/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min.css',
    ];

    protected static $js = [
        '/packages/admin/laravel-admin/bootstrap-switch/dist/js/bootstrap-switch.min.js',
    ];
